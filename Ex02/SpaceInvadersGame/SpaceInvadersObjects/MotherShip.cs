...
namespace SpaceInvadersGame
{
    internal class MotherShip : Enemy, ICollidable2D
    {
        ...
        internal MotherShip(Game i_Game, int i_DrawOrder, int i_UpdateOrder, Vector2 i_EnemyPosition, SpaceInvadersEnums.eEnemyType i_EnemyType)
            : base(i_Game, i_DrawOrder, i_UpdateOrder, i_EnemyPosition, i_EnemyType)
        {
        ...
        public override void Collided(ICollidable i_Collidable)
        {
            ...
            if (spaceShipBullet != null && spaceShipBullet.IsBottomUp() && !m_GotHit)
            {
