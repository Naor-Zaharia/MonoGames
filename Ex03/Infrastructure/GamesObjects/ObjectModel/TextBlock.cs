...
namespace Infrastructure.GamesObjects.ObjectModel
{
    public class TextBlock : Sprite, ITextBlock
    {
        ...
        public override void Draw(GameTime i_GameTime)
        {
            ...
            m_SpriteBatch.DrawString(m_FontName, m_Text, this.PositionForDraw, this.TextColor, this.Rotation, this.RotationOrigin, this.Scales, SpriteEffects.None, this.LayerDepth);
        ...
        {
            m_WidthBeforeScale = MeasureString.X;
            m_HeightBeforeScale = MeasureString.Y;
